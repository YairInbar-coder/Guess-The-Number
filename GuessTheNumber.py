...
def main():
    ...
    def handle_click():
        ...
        if guess == number:
            temporery_label(app, 'Correct!')
            number = random.randint(1, 100)
        elif guess < number:
            temporery_label(app, 'Too low!')
        else:
            temporery_label(app, 'Too high!')
    ...
    enter = ctk.CTkButton(app, text="Enter", command=handle_click)
